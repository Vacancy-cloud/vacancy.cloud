const HowItWorks = () => {
  const steps = [
    {
      title: 'INPUT',
      description: 'GIS layers, cadastral data, photogrammetry scans, inspection reports',
      icon: (
    ...
    {
      title: 'AI ENGINE',
      description: 'Risk-scoring, ROI calculation, scenario optimization',
      icon: (
        <svg className="w-12 h-12" fill="none" viewBox="0 0 24 24" stroke="currentColor">
    ...
    {
      title: 'OUTPUT',
      description: 'Investment potential, cost estimates, actionable PDF reports',
      icon: (
        <svg className="w-12 h-12" fill="none" viewBox="0 0 24 24" stroke="currentColor">
    ...
    <section id="how-it-works" className="py-20 bg-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <p className="text-center text-text-muted text-lg mb-12 max-w-2xl mx-auto">
          Our AI-powered platform transforms raw building data into actionable insights
        </p>
